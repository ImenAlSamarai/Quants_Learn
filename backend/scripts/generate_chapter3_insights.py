"""
Extract and generate practitioner insights for Chapter 3 topics

This script:
1. Extracts bibliographic notes and discussion sections from Chapter 3
2. Uses LLM to structure into actionable insights
3. Saves to database for display in frontend modal
"""
...
class InsightsGenerator:
    ...
    def extract_bibliographic_notes(self, chapter_num: int) -> str:
        ...
        # Find "Bibliographic Notes" section
        start_idx = None
        ...
        # Find end (usually "Exercises" or "References" or next chapter)
        end_idx = len(lines)
...
"""
    ...
    def generate_insights_for_topic(self, node: Node, chapter_num: int):
        ...
        # Extract bibliographic notes from the chapter
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Generate insights for Chapter 3 topics")
    ...
    print("=" * 80)
    print("Chapter 3 Insights Generation")
    print("=" * 80)

    # Get Chapter 3 topics
    chapter_3_topics = [
    ...
    try:
        for topic_title in chapter_3_topics:
            # Find the node
            ...
            # Generate insights
            generator.generate_insights_for_topic(node, chapter_num=3)

        print("\n" + "=" * 80)
        print("✓ Chapter 3 insights generation completed!")
        print()
        print("Test the insights:")
        print("  1. Start backend: uvicorn app.main:app --reload")
        print("  2. Visit: http://localhost:8000/api/insights/{node_id}")
        print("  3. Or check frontend modal")

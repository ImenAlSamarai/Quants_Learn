"""
Extract and generate practitioner insights for Chapter 14 topics (Unsupervised Learning)
"""
...
"""
    ...
    def generate_insights_for_topic(self, node: Node, chapter_num: int):
        ...
        if not biblio_notes or len(biblio_notes) < 100:
            print(f"  No bibliographic notes for Chapter {chapter_num}, using fallback")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Generate insights for Chapter 14 topics")
    ...
    print("=" * 80)
    print("Chapter 14 Insights Generation: Unsupervised Learning")
    print("=" * 80)
    ...
    try:
        for topic_title in chapter_14_topics:
            ...
            generator.generate_insights_for_topic(node, chapter_num=14)

        print("\n" + "=" * 80)
        print("✓ Chapter 14 insights generation completed!")

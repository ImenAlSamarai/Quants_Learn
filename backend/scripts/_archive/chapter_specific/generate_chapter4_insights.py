"""
Extract and generate practitioner insights for Chapter 4 topics (Classification)
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Generate insights for Chapter 4 topics")
    ...
    print("=" * 80)
    print("Chapter 4 Insights Generation: Classification Methods")
    print("=" * 80)

    # Get Chapter 4 topics
    chapter_4_topics = [
        "Logistic Regression",
    ...
    try:
        for topic_title in chapter_4_topics:
            ...
            generator.generate_insights_for_topic(node, chapter_num=4)

        print("\n" + "=" * 80)
        print("✓ Chapter 4 insights generation completed!")

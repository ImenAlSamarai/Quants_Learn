...
print("  - topic_structures (NEW - for caching learning structures)")
print("\n💡 The TopicStructure table will cache:")
print("  - Learning structures (weeks/sections) for topics")
print("  - First generation: ~$0.006 with gpt-4o-mini")
print("  - All subsequent retrievals: FREE!")
